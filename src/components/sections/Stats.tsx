...
export const Stats = () => {
  ...
  return (
    <section className="py-12 md:py-20 bg-card/30 border-y border-border/50 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {statsData.map((stat, i) => (
            <div key={i} className="group relative">
               ...
               <Card className="relative h-full border border-border/50 bg-card/50 backdrop-blur-xl rounded-[1.5rem] sm:rounded-[2.5rem] overflow-hidden shadow-xl hover:border-primary/50 transition-all duration-500">
                  ...
                  <CardContent className="p-5 sm:p-8">
                    ...
                    <div className="space-y-1">
                       ...
                       <div className="text-2xl sm:text-4xl font-black font-headline tracking-tighter flex items-end gap-1 text-foreground">
                          {stat.value}
